...
public class CustomRadioGroup extends LinearLayout {
    ...
    private void parseAttributes(AttributeSet attrs) {
        ...
        try {
            mCheckedId = a.getResourceId(R.styleable.CustomRadioGroup_customRadioCheckedId, View.NO_ID);
    ...
    private void setCheckedId(@IdRes int id, boolean isChecked) {
        ...
        if (mOnCheckedChangeListener != null) {
            mOnCheckedChangeListener.onCheckedChanged(this, (CustomRadioButton) mChildViewsMap.get(id), isChecked, mCheckedId);
        }
    }
    ...
    public static interface OnCheckedChangeListener {
        void onCheckedChanged(View radioGroup, CustomRadioButton radioButton, boolean isChecked, int checkedId);
    }
    //================================================================================
    // Inner classes
    //================================================================================
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == CustomRadioGroup.this && child instanceof RadioCheckable) {
                int id = child.getId();
                ...
                ((RadioCheckable) child).addOnCheckChangeListner(
        ...
        public void onChildViewRemoved(View parent, View child) {
            if (parent == CustomRadioGroup.this && child instanceof RadioCheckable) {
                ((RadioCheckable) child).removeOnCheckChangeListner(mChildOnCheckedChangeListener);
            }
